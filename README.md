...
However, for those who prefer a cleaner hotbar UI, I made an update so now it removes the smaller numbers from the vanilla hotbar, since this numbers are bigger than before. Extended Hotbars mod has this feature as well (only for the extended hotkeys).

Before:<br>
<img width="594" height="83" alt="image" src="https://github.com/user-attachments/assets/04144067-6463-422b-b630-b959ce978007" />

After:<br>
<img width="598" height="80" alt="image" src="https://github.com/user-attachments/assets/a7bba971-6729-4978-a6a3-63a9c6904812" />
