...
However, for those who prefer a cleaner hotbar UI, I made an update so now it removes the smaller numbers from the vanilla hotbar, since this numbers are bigger than before. Extended Hotbars mod has this feature as well.
